...
const part: PartDefinition = {
  ...
  icon: 'wheel',
  description: 'Motor-and-screw actuator envelope with adjustable stroke and rod extension.',
  complexity: 'Parametric prototype',
  keywords: [
    'electric linear actuator',
    'linear actuator',
    'Electric actuator \u00b7 100 mm stroke',
    'Electric actuator \u00b7 200 mm stroke',
  ],
  defaults,
  parameters,
  ...
  validate(p, state) {
    ...
    if (
      ...
      n(p, 'stroke') >= n(p, 'bodyLength') ||
      n(p, 'rod') >= n(p, 'diameter') - 3
    )
      errors.push('Stroke, rod and extension must fit the actuator tube.');
    return errors;
  },
