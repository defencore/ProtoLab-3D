...
const part: PartDefinition = {
  id: 'plain-bushing',
  name: 'Plain sleeve bushing',
  category: 'BEARINGS & SEALS',
  subgroup: 'PLAIN BEARINGS',
  icon: 'bearing',
  description: 'Cylindrical and flanged sliding bushings, with optional lubrication groove.',
  complexity: 'Parametric prototype',
  keywords: [
    'plain sleeve bushing',
    'plain bushing',
    'Sleeve bushing \u00b7 \u00d816 / \u00d820 \u00d7 20 mm',
    'Flanged bushing \u00b7 \u00d816 bore',
  ],
  defaults,
  parameters,
  ...
  validate(p, state) {
    ...
    if (
      n(p, 'diameter') <= n(p, 'bore') ||
      n(p, 'flange') < n(p, 'diameter') ||
      n(p, 'flangeHeight') >= n(p, 'length')
    )
      errors.push('Bushing wall and flange must have positive thickness.');
    return errors;
  },
