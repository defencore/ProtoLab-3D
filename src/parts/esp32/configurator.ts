...
export const defaults: Parameters = { model: 'esp32-devkitc-v4' };
...
export const catalogFilterFields: ParameterDefinition[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: '38-pin headers',
        label: '38-pin headers',
      },
      {
        value: 'Castellated pads',
        label: 'Castellated pads',
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: 'Wi-Fi / BLE / U.FL',
        label: 'Wi-Fi / BLE / U.FL',
      },
    ],
  },
  {
